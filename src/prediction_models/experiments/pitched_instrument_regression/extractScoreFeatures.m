function [features] = extractScoreFeatures(audio, f0, Fs, wSize, hop, score_path, NUM_FEATURES)
...
if flag == 1
    ...
    [algndmid1, note_onsets1, dtw_cost1, path1] = alignScore(score_path, tfCompnstdF0, audio, Fs, wSize, hop);
    [algndmid2, note_onsets2, dtw_cost2, path2] = alignScore(score_path, tfCompnstdF02, audio, Fs, wSize, hop);
    ...
    [algndmidi, note_altrd, dtw_cost, path] = alignScore(score_path, tfCompnstdF0, audio, Fs, wSize, hop);
end
