...
function notes = getNotesForSegmentPyin(BAND_OPTION, INSTRUMENT_OPTION, SEGMENT_OPTION, YEAR_OPTION, NUM_FEATURES, thres, thinning)
...
for student_idx = 1:num_students
    ...
    % extract features
    f0_features = extractNotes(normalized_audio, f0, resample_fs, HOP_SIZE, thres, thinning);
    notes{student_idx} = f0_features;
